...
<body>
    ...
    <section class=" ">
        <div class="cdenter">
            ...
            <div class="container px-4 px-lg-5 md-5 mt-5">
                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">


                    <!-- ------ inicio de Frutas --- -->
                    <!-- Primer contenedor  frutas-->
                    <div class="col mb-5">
