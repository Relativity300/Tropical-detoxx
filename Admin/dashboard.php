            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="white-box">
                                ...
                                <table class="table no-wrap">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>jugo Personalizado</td>
                                            <td class="txt-oflo">10</td>
                                            <td class="txt-oflo">1/12/2022</td>
                                            ...
                                            <td class="txt-oflo">
                                                ...
                                                <!-- detalles -->
                                                <button type="button" class="button" data-bs-toggle="modal" data-bs-target="#Personalizado">
                        ...
                        <!-- Modal2 -->
                        <div class="modal fade" id="Personalizado" tabindex="-1" aria-labelledby="Datos" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h1 class="titulo-Modal ">Detalles: 1.</h1>
