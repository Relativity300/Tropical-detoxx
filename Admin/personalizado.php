...
<body>
    ...
    <section class=" ">
        <div class="cdenter">
            ...
            <div class="pt-5">
                <h1 class="display-4 text-center ">Personalizado</h1>
            </div>
            ...
            <div class="centers col-lg-9 col-sm-8 col-md-8 col-xs-12">
            ...
            <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h1 class="modal-title fs-5" id="exampleModalLabel">Crear personalizado</h1>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                    ...
                    <div class="col mb-5">
                        <div class="card h-100">
                            ...
                            <div class="box-2 text-center">
                                ...
                                <!-- Eliminar -->
                                <button type="button" class="button" onclick="validarFormulario3()" data-bs-toggle="modal" data-bs-target="#elliminar">
