...
<body>
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
        ...
        <div class="page-wrapper">
                ...
                <div class="modal-dialog">
                    <div class="modal-content wh">
                        <div class="modal-header">
                            ...
                            <button class="mas  aa btn btn-primary">Agregar</button>
                            ...
                            <div class="cotenidoEdit">
                                <div class="editar">
                                    ...
                                    <ul>
                                        <li class="edi">jugo Mango $2.000<input type="checkbox" class="seletor1"
                                                id="cbox1" value="first_checkbox"> <input type="number" name="" id=""
                                                class="cantidad"> <br></li>
                                        <li class="edi">jugo Piña $2.000<input type="checkbox" class="seletor1"
                                                id="cbox1" value="first_checkbox"> <input type="number" name="" id=""
                                                class="cantidad"></li>
                                        <li class="edi">jugo coco $2.000<input type="checkbox" class="seletor1"
                                                id="cbox1" value="first_checkbox"> <input type="number" name="" id=""
                                                class="cantidad"></li>
                                        <li class="edi">jugo Pomelo $2.000<input type="checkbox" class="seletor1"
                                                id="cbox1" value="first_checkbox"> <input type="number" name="" id=""
                                                class="cantidad"></li>
                                        <li class="edi">jugo Aguacate $2.000<input type="checkbox" class="seletor1"
                                                id="cbox1" value="first_checkbox"> <input type="number" name="" id=""
                                                class="cantidad"></li>
                                    </ul>
                                </div>
                                <div class="editar">
                                    ...
                                    <ul>
                                        ...
                                        <li class="edi">Pomelo $2.000<input type="checkbox" class="seletor1" id="cbox1"
                                                value="first_checkbox"> <input type="number" name="" id=""
                                                class="cantidad"></li>
                                        <li class="edi">Aguacate $2.000<input type="checkbox" class="seletor1"
                                                id="cbox1" value="first_checkbox"> <input type="number" name="" id=""
                                                class="cantidad"></li>
                                    </ul>
                                </div>
            ...
            <!--Modal Personalizado -->
            <div class="modal fade" id="Personalizado" tabindex="-1" aria-labelledby="Personalizado" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content wh">
                        <div class="modal-header">
                            <h1 class="titulo-Modal ">Crear Personalizado</h1>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body modallll">
                            <form action="">
                                ...
                                <div class="editar">
                                    ...
                                    <ul>
                                        ...
                                        <li class="edi">Piña $2.000 <input type="checkbox" class="seletor1" id="cbox1"
                                                value="first_checkbox"> <input type="number" name="" id=""
                                                class="cantidad"></li>
                                        <li class="edi">Manzanas $2.000 <input type="checkbox" class="seletor1"
                                                id="cbox1" value="first_checkbox"> <input type="number" name="" id=""
                                                class="cantidad"></li>
                                        <li class="edi">Coco $2.000 <input type="checkbox" class="seletor1" id="cbox1"
                                                value="first_checkbox"> <input type="number" name="" id=""
            ...
            <div class="modal fade" id="editar" tabindex="-1" aria-labelledby="editar" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content wh">
                        <div class="modal-header">
                            <h1 class="titulo-Modal ">Editar pedidos</h1>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body modallll">
                            <form action="">
                        ...
                        <div class="modal-body hw">
                            <div class="contenedor">
                                ...
                                <div class="pedido">
                                    ...
                                    <ul>
                                        <li class="li"><b>Vaso:</b> 2 de mango <br><b>Tamaño:</b>
                                            medio<br><b>Precio:</b> 2.000 </li>
                                        <li class="li"><b>Vaso:</b> 1 de mango <br><b>Tamaño:</b>
                                            medio<br><b>Precio:</b> 1.000 </li>
                                        <li class="li"><b>Vaso:</b> 3 de mango <br><b>Tamaño:</b>
                                            medio<br><b>Precio:</b> 3.000 </li>
                        ...
                        <div class="modal-body hw">
                            <div class="contenedor">
                                <div class="datos">
                                    ...
                                    <p class="li"><b>Estado:</b> en proceso</p>
                                    <p class="li"><b>Direcion:</b> Santa lucia</p>
                                    <p class="li"><b>Personalizado:</b> Si</p>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="">
                                <h1 class="tilepedido">Prductos</h1>
                                <ul class="ulEli">
                                    <li class="li"><b>Vaso:</b> 2 de mango <b>Tamaño:</b> medio<b> Precio:</b> 2.000
                                    </li>
                                    <li class="li"><b>Vaso:</b> 1 de mango <b>Tamaño:</b> medio<b> Precio:</b> 1.000
                                    </li>
                                    <li class="li"><b>Vaso:</b> 3 de mango <b>Tamaño:</b> medio<b> Precio:</b> 3.000
                                    </li>
                                    <li class="li"><b>Total:<samp> 6.000</samp></b></li>
                                </ul>
                            </div>
