...
<div class="card" style="width: 18rem;">
  ...
  <div class="botones">
    <button class="button-boton"><i class="bi bi-cart-x icono"><svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-cart-x" viewBox="0 0 16 16">
    ...
    <p class="p-jugo">jugo de mango | cantidad: 3</p>
  </div>
