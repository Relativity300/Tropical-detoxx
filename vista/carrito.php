  ...
  <div class="modal fade" id="Conpar" tabindex="-1" aria-labelledby="Conpar" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <h6>#1: jugo de mango / antidad: 1 / tamaño: pequelo.</h6> 
          <h6>#2: jugo de mango / antidad: 1 / tamaño: pequelo.</h6> 
          <h6>#3: jugo de mango / antidad: 1 / tamaño: pequelo.</h6> 
        </div>
        <div class="modal-footer">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a href="carrito.php"><button type="button" class="btn btn-primary"> Pedir</button></a>
      </div>
    </div>
  </div>
</div>
