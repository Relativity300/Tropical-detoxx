  ...
  <header class="ca">
    <nav class="navbar navv navbar-dark bg ">
      <div class="container">
        ...
        <a class="a navbar-brand" href="personalizado.php">
          <p class="p">Personalizados</p>
        </a>
        <a class="a navbar-brand" href="carrito.php">
          <p class="p">Carrito</p>
        </a>
        <div class="div-logo"><a class="a " href="index.php"> <img class="logo" src="../IMG/Logo1.png" alt="logo"></a></div>
        <a class="a navbar-brand" href="categoria.php">
          <p class="p">Productos</p>
        </a>
        <a class="a navbar-brand" href="login.php">
          <p class="p">Login</p>
        </a>
        ...
        <div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel">
          <div class="offcanvas-header">
            <h5 class="offcanvas-title" id="offcanvasDarkNavbarLabel">Tropical Detox</h5>
