...
<body>
        ...
        <div class="modal-dialog modal-sm modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h2 class="fs-3 text-md-center">Jugo de manzana</h2>
    ...
    <div class="modal fade" id="myModal2">
        <div class="modal-dialog modal-sm modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h2 class="fs-4 text-md-center">Jugo de piña</h2>
    ...
    <!-- Fin del modal 2 frutas-->

    <!-- Inicio de modal 3 frutas-->
    <div class="modal fade" id="myModal3">
        <div class="modal-dialog modal-sm modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h2 class="fs-3 text-md-center">Jugo de guayaba</h2>
                    <!-- <a href="carrito.php"> -->
